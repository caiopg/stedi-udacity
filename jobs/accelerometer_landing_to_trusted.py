...
AccelerometerTrusted_node1726873247382 = glueContext.write_dynamic_frame.from_options(frame=DropCustomerFields_node1727041453530, connection_type="s3", format="json", connection_options={"path": "s3://stedi-lh/accelerometer/trusted/", "partitionKeys": []}, transformation_ctx="AccelerometerTrusted_node1726873247382")
